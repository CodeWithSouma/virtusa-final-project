 ...
 const handleClick=(e)=>
 {
   ...
   if(description==''){setDescriptionError(true)}
    ...
    const deleteClick=(e)=>
    {
     ...
     fetch("http://localhost:8080/admin/EditVehicle",
     {
         method:"POST",
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
   ...
   <br></br>
    ...
    <script src="https://kit.fontawesome.com/yourcode.js" crossorigin="anonymous"></script>
     <div class="col-4" >
     <div class="card" style={{width: '1000', margin:'1px',float:'left', borderRadius:'25px'}}>
        <img class="card-img-top" src="https://images.newindianexpress.com/uploads/user/imagelibrary/2021/4/12/w900X450/Train.jpg?w=400&dpr=2.6" alt="Card image cap" style={{height:'500',borderRadius:'20px 20px 0px 0px'}}/>
        <div class="card-body" style={{backgroundColor:' #293d3d',height:'600',borderRadius:'0px 0px 20px 20px'}}>
          <h5 class="card-title"  style={{color: 'white'}}>Cheran Exp. </h5>
          <p class="card-text" style={{color: 'white'}}>Address:</p>
          <div style={{display:'block',float:'right'}}>
        <i class="fa fa-trash-o" style={{font:'150px',color:'white' ,onClick={deleteClick}}} onlc></i>
        </div>
          <p class="card-text" style={{color: 'white'}}>Available Timing:</p>
          <div style={{display:'block',float:'right'}}>
        <i class="fa fa-edit" style={{font:'150px',color:'white',onClick={editClick}}}></i>
        </div>
         
          <p class="card-text" style={{color: 'white'}}>Price:</p> 
